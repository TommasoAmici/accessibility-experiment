const bgFromColor: ProductUI = {
  ...
  black: "bg-black hover:bg-neutral-700 focus:bg-black",
...
const checkboxFromColor: ProductUI = {
  ...
  yellow: "bg-yellow-400 text-yellow-400 black-checkmark",
  orange: "bg-orange-400 text-orange-400 black-checkmark",
  beige: "bg-[#e5cfb2] text-[#e5cfb2] black-checkmark",
